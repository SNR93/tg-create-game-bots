 ...
 * Здесь подключаются глобальные стили и корневой компонент, который дальше строит страницы редактора и списка ботов.
 * Файл должен оставаться минимальным: бизнес-логика уходит в страницы, хуки и компоненты.
