 ...
 * Утилиты анализа сценарного графа: команды, стартовые точки, связи, валидация структуры и поиск следующих нод.
 * Файл используется и при сохранении сценария, и при запуске runtime, поэтому он держит общие правила графа в одном месте.
 * Если добавляется новый тип ноды, часто нужно обновить этот модуль вместе с каталогом frontend-ноды.
