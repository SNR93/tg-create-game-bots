 ...
 * Инициализация PostgreSQL-схемы и подключение к базе.
 * Миграции описаны идемпотентно, чтобы контейнер мог стартовать повторно без ручной подготовки БД.
 * Любое изменение таблиц должно учитывать уже существующие production-данные игроков.
