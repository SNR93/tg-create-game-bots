 ...
 * Абстракция хранения игровых сессий в Redis с fallback/сериализацией.
 * Сессия содержит текущую позицию игрока в сценарии и временные данные выполнения.
 * Модуль нужен, чтобы рестарт backend не сбрасывал прохождение у игроков.
