...
Веб-интерфейс защищён страницей входа. В редакторе есть поиск по схеме, лор проекта, сворачивание нод, встроенная проверка сценария, автосохранение, история изменений, копирование/вставка нод, справка с поиском и настройки с экспортом JSON и админ-панелью.

### Лор и форматирование текста
Лор хранится вместе с ботом и помогает вести персонажей, правила мира и заметки автора. Тексты сообщений поддерживают плейсхолдеры `{{Переменная}}` и Telegram HTML-разметку: жирный, курсив, подчёркивание, зачёркивание, спойлер, код и ссылки.
